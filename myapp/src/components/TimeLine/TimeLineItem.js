...
// export const TimelineItem = ({ item, isOdd }) => {
...
//           <FaUniversity />
//         </div>
//         <span className="sm:hidden font-bold text-right font-body text-base">
//           {date.format("MMM YYYY")}
//         </span>
//         <span className="text-lg xs:text-xl font-bold font-display col-span-2">
//           {item.title}
//         </span>
