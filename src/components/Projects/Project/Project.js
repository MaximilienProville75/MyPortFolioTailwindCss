...
import { default as gitHubLogo } from "../../../assets/github-brands.svg";
      ...
      <div className="Project shrink-0 w-6/12 mt-20 snap-center relative max-w-4xl">
        <div className="h-5/6 w-100 ">
          <img
            ...
            className="h-96 w-full rounded-3xl ring-4 ring-purple-500 ring-offset-4 ring-offset-gray-900 shadow-purple-300/80 shadow-xl object-cover"
          />
